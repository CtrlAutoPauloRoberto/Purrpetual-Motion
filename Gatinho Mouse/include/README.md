...
![Project Status](https://img.shields.io/badge/Status-Active-brightgreen) ![Hardware](https://img.shields.io/badge/Hardware-LilyGO_T--Display_S3-blue) ![License](https://img.shields.io/badge/License-MIT-yellow)
...
Unlike standard jigglers, this project uses a **human-like movement algorithm** and spoofs the Bluetooth ID of a legitimate Logitech mouse.
...
* USB-C Cable.
* (Optional) 3D Printed case for a desktop finish.
